...
# step 1: put the package manager on PATH, for your own lifecycle scripts. From yarn.lock, yarn@4.17.0
corepack enable

# step 2: dependencies, from your lockfile. From yarn.lock, yarn@4.17.0
corepack yarn install --immutable

# step 3: your build. From ci.yml::build
make -j build-standalone-ci

# step 4: your build. From ci.yml::build
